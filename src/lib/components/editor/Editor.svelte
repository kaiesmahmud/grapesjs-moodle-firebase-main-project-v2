<script>
    ...
    // import { updateSummary } from '../../fetch/UpdateData.js';
    ...
    let editor;
    let updatedHtml = heroSection; // Store the edited HTML
      ...
      editor = grapesjs.init({
        ...
        canvas: {
          styles: [
            ...
            "./editorCss.css",
            // "../../app.pcss",
             //Not working and Throwing Error
          ],
  ...
  <!-- <div class="html-editor ">
    ...
    <button  class={`${cssbtn} inline-block mt-10`}>Update Course</button>
  </div> -->
<style>
